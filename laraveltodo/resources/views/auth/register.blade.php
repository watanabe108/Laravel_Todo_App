            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="family_name" class="col-md-4 col-form-label text-md-right">family_name</label>
                        ...
                        <div class="form-group row">
                            <label for="user" class="col-md-4 col-form-label text-md-right">user_name</label>
